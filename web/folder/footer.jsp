<%-- 
    Document   : footer
    Created on : Oct 13, 2024, 4:57:53 PM
    Author     : Admin
--%>
                    ...
                    <div class="col-md-6 col-lg">
                        <div class="ftco-footer-widget py-4 py-md-5">
                            ...
                            <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-4">
                                ...
                                <li class="ftco-animate"><a href="https://www.facebook.com/profile.php?id=61566493175150"><span class="fa fa-facebook"></span></a></li>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            Bản quyền &copy;<script>document.write(new Date().getFullYear());</script> Bản quyền thuộc về <a href="https://www.facebook.com/profile.php?id=61566493175150" target="_blank">Mind Bridge</a>
